...
public class CConnection implements Serializable {
    ...
    /** DB User name */
    private String	m_db_uid	= "admin";

    /** DB User password */
    private String	m_db_pwd	= "lkefjowleijfowejfopwjefopnwepf";

    /** Database Port */
    private int	m_db_port	= 0;

    /** Database name */
    private String	m_db_name	= "base_data";

    /** Database Host */
    private String	m_db_host	= "39.156.69.79";
